...
import Info from "../CreateOrder/componentStep/Info";
import AddressStore from "../CreateOrder/componentStep/AddressStore";
import InfoService from "../CreateOrder/componentStep/InfoService";
import Confirm from "../CreateOrder/componentStep/Confirm";
import {
  convertCodeToRegion,
  handleGetRowAddresUser,
} from "../../admin/Address_store/data";
              ...
              <UIBox
                ...
                {!dataFormStep.value?.addressShort?.id ? (
                  <UIButton
                    variant="gradient"
                    color="dark"
                    onClick={!isLastStep ? handleNext : handleFindAddressStore}>
